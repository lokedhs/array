...
The syntax to do this was demonstrated in the previous section.
...
After running the above, the variable `bar` will contain a 2-dimensional array that looks like the following:
...
After the above have been run, the variable `value` contains `15`.
