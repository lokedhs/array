...
class ExtendedCharsInputField : TextField() {
    ...
    init {
        ...
        keymap = hashMapOf(
            // First row
            KeyDescriptor("`") to "◊",
            KeyDescriptor("1") to "¨", KeyDescriptor("1") to "⌶",
            KeyDescriptor("2") to "¯", KeyDescriptor("1") to "⍫",
            KeyDescriptor("3") to "<", KeyDescriptor("1") to "⍒",
            KeyDescriptor("4") to "≤", KeyDescriptor("1") to "⍋",
            KeyDescriptor("5") to "=", KeyDescriptor("1") to "⌽",
            KeyDescriptor("6") to "≥", KeyDescriptor("1") to "⍉",
            KeyDescriptor("7") to ">", KeyDescriptor("1") to "⊖",
